...
\begin{document}
    ...
    \begin{itemize}
        \item\textbf{Desarrolador: Diego Valdés} será responsable de la programación y ensamblaje del controlador ESP-32 y sus sensores.
        \item\textbf{Coordinador: Camila Valencia}
        \item\textbf{Documentación: Cristobal gonzalez}
        \item\textbf{Investigador: Renato Riveros}
    \end{itemize}
    ...
    Perros guias: Una de las soluciones mas completas para este tipo de personas ya que avisa de obstaculos, localiza puertas, asientos, escaleras, entre otras cosas fundamentales para la navegación en lugares publicos y sirven de apollo emocional,
    ...
    Baston: el clasico que ha siempre ha acompañado a los ciegos, este los ayuda a identificar desniveles y objetos en su camino a traves del simple tacto

    OrCam MyEye: Se comercializa en Chile por un valor aproximado de 7.568.990, Es un dispositivo de visión artificial que se acopla a los lentes para leer texto y reconocer rostros. Su elevado precio representa la mayor barrera de entrada para el usuario promedio en Chile.

    WeWalk Smart Cane: Un bastón electrónico con sensores ultrasónicos para detectar obstáculos elevados y navegación GPS integrada. Tiene un precio internacional de 599 USD, requiere conectividad constante para sus funciones de navegación.

    Lentes eSight: Utilizados para potenciar la baja visión mediante pantallas internas de alta resolución. Su costo de adquisición ronda los 7.000 USD, lo que los sitúa en el segmento de alta gama inaccesible para la mayoría de los beneficiarios de la ley de inclusión en Chile.

    Seeing AI (Microsoft): Es una aplicación gratuita altamente efectiva para reconocer textos, billetes y rostros. Su gran desventaja operativa es que obliga al usuario a sostener el celular con una mano, bloqueando un sentido táctil fundamental y exponiéndolo a riesgos de seguridad o caídas.

    Asistencia Remota (Be My Eyes): Conecta al usuario mediante videollamada con voluntarios videntes que pueden ayudar en tareas específicas como verificar la fecha de vencimiento de un alimento o leer una pantalla.

Reconocimiento y OCR (Envision AI / Seeing AI): Utilizan Inteligencia Artificial para leer textos impresos en más de 60 idiomas, describir escenas visuales, identificar colores, rostros de amigos y escanear códigos de barras de productos.
